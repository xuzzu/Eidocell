...
class CustomInfoBar(QFrame):
    ...
    def __setQss(self):
        ...
        # if error then set the background color to red
        if self.icon == InfoBarIcon.ERROR:
            self.setCustomBackgroundColor("#ff9d96", "#202020")
        elif self.icon == InfoBarIcon.WARNING:
            self.setCustomBackgroundColor("#ffeb3b", "#202020")
        elif self.icon == InfoBarIcon.SUCCESS:
            self.setCustomBackgroundColor("#b9f6ca", "#202020")
        else:
            self.setCustomBackgroundColor("#d7f1fc", "#202020")
...
class InfoBarManager(QObject):
    ...
    def add(self, infoBar: CustomInfoBar):
        """add info bar"""
    ...
    def remove(self, infoBar: CustomInfoBar):
        """remove info bar"""
        p = infoBar.parent()
        if p not in self.infoBars:
            return
    ...
    def _createSlideAni(self, infoBar: CustomInfoBar):
    ...
    def _pos(self, infoBar: CustomInfoBar, parentSize=None) -> QPoint:
        """return the position of info bar"""
        raise NotImplementedError

    def _slideStartPos(self, infoBar: CustomInfoBar) -> QPoint:
...
class TopInfoBarManager(InfoBarManager):
    ...
    def _pos(self, infoBar: CustomInfoBar, parentSize=None):
        p = infoBar.parent()
    ...
    def _slideStartPos(self, infoBar: CustomInfoBar):
...
class BottomLeftInfoBarManager(InfoBarManager):
    ...
    def _pos(self, infoBar: CustomInfoBar, parentSize: QSize = None) -> QPoint:
        p = infoBar.parent()
        parentSize = parentSize or p.size()
